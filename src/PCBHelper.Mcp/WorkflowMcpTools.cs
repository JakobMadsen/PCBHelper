...
public sealed class WorkflowMcpTools
{
    ...
    public ToolResponse<DesignBlockAuthoringPreview> PreviewDesignBlockImport(
        ...
        [Description("PCBHelper block manifest JSON. Native payload filenames and hashes are generated by PCBHelper.")] JsonElement manifest) =>
        _runtime.DesignBlocks.PreviewImport(libraryPath, sourceBlockPath, manifest.GetRawText());
    ...
    public ToolResponse<DesignBlockAuthoringResult> ApplyDesignBlockImport(
        ...
        _runtime.DesignBlocks.ApplyImport(libraryPath, sourceBlockPath, manifest.GetRawText(), expectedPlanHash);
    ...
    public ToolResponse<DesignBlockAuthoringPreview> PreviewDesignBlockCreate(
        ...
        _runtime.DesignBlocks.PreviewCreate(libraryPath, sourcePath, manifest.GetRawText(), boardPath);
    ...
    public ToolResponse<DesignBlockAuthoringResult> ApplyDesignBlockCreate(
        ...
        string expectedPlanHash,
        string? boardPath = null) =>
        _runtime.DesignBlocks.ApplyCreate(libraryPath, sourcePath, manifest.GetRawText(), expectedPlanHash, boardPath);
    ...
    public ToolResponse<BestPracticeReviewReport> SubmitBestPracticeReview(
        ...
        _runtime.BestPractices.Submit(projectPath, assessment.GetRawText(), expectedEvidenceHash);
