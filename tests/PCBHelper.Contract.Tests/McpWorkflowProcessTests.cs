    ...
    public async Task Default_Profile_Handshakes_And_Lists_Exactly_Workflow_Tools()
    {
        ...
        try
        {
            ...
            Assert.Equal(new HashSet<string>(StringComparer.Ordinal)
            {
                ...
                "get_project_context", "get_schematic_context", "analyze_schematic_readability", "analyze_board_readability",
                "validate_layout_constraints", "run_layout_constraint_proofs", "get_workflow_status", "list_artifacts", "get_artifact",
                "get_net_routing_context", "validate_design_plan", "preview_design_plan", "apply_design_plan",
